    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF6C63FF), // FIXED: was 0xFF6C63FF
...
class _DateTimePickerFormState extends State<DateTimePickerForm> {
    ...
    if (_formKey.currentState!.validate()) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          backgroundColor: const Color(0xFF6C63FF), // FIXED: was 0xFF6FC63FF
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFF6C63FF), // FIXED: was 0xFFFFF5F4FF (9 digits)
      appBar: AppBar(
        backgroundColor: const Color(0xFF6C63FF), // FIXED: was 0xFF6FC63FF
            ...
            children: [
              ...
              FilledButton.icon(
                ...
                style: FilledButton.styleFrom(
                  backgroundColor: const Color(0xFF6C63FF), // FIXED
              ...
              OutlinedButton.icon(
                ...
                style: OutlinedButton.styleFrom(
                  foregroundColor: const Color(0xFF6C63FF), // FIXED
                  side: const BorderSide(color: Color(0xFF6C63FF)),  // FIXED
  ...
  InputDecoration _deco({
    ...
    return InputDecoration(
      labelText: label,
      hintText: hint,
      prefixIcon: Icon(icon, color: const Color(0xFF6C63FF), size: 20), // FIXED
      suffixIcon: suffix,
      filled: true,
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: const BorderSide(color: Color(0xFF6C63FF), width: 1.5), // FIXED
      ),
      ...
      labelStyle: const TextStyle(color: Color(0xFF72B0FF)),  // FIXED: was 0xFF6FF672B0
      hintStyle: const TextStyle(color: Color(0xFFB07CB3), fontSize: 14), // FIXED: was 0xFF0FB07C3
    );
  }
  ...
  Widget _buildPreviewCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF6C63FF).withOpacity(0.08), // FIXED
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: const Color(0xFF6C63FF).withOpacity(0.2), width: 1), // FIXED
      ),
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.preview_rounded, color: Color(0xFF6C63FF), size: 18), // FIXED
  ...
  Widget _previewRow(IconData icon, String label, String value) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, size: 15, color: const Color(0xFF6C63FF)), // FIXED
          const SizedBox(width: 6),
          Text(
            '$label: ',
            style: const TextStyle(
              ...
              fontSize: 13,
              color: Color(0xFF4B5563), // FIXED: was 0xFF6FF4B5563
            ),
          ),
          Expanded(
            child: Text(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF6C63FF).withOpacity(0.06), // FIXED
            blurRadius: 16,
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFF6C63FF).withOpacity(0.1), // FIXED
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Icon(icon, color: const Color(0xFF6C63FF), size: 18), // FIXED
              ),
